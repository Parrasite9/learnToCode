...
1. Add original remote repo with `git remote add upstream git@git.generalassemb.ly:Software-Engineering-Immersive-Remote/SEIR-Ewoks.git`
...
1. You may get thrown into a terminal-based text editor called Vim.  If you see a bunch of [scary looking text](https://i.imgur.com/GXGgEiw.png) and a lot of `#`, simply type `:wq` and hit `Enter`
3. If you get a message about divergent branches, run `git config --global pull.rebase false` and pull again
