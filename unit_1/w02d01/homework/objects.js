...
setup.clutter = ["mail", "trash", "cups", "trash"]

// I HAVE NO IDEA WHAT #4 IS ASKING
...
setup.computer = {
  files: ["app.js", "object.js", "index.html", "styles.css"]
}

// THE FOLLOWING FOR LOOPS ARE NOT WORKING. IVE TRIED MANY VARIATIONS OF CONSOLE.LOG AND NOTHING SHOWS WITHIN THE TERMINAL.
  for (let i = 0; i < setup.computer.files; i++) {
    console.log(i);
}
