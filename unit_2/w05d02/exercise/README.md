...
1. Use the files inside the `exercise/bootstrap` folder to code along with this exercise.
...
1. Go to [Bootstrap's framework page](https://getbootstrap.com/docs/5.1/getting-started/introduction/) to get their stylesheets.
...
2. Let's give each of the divs that surrounds the paragraph tags a `class="col-sm"`
...
Bootstrap has something called `jumbotron` which has styling to showcase a section. (deprecated in v.5.1, to implement 'jumbotron' use older version https://getbootstrap.com/docs/4.6/getting-started/introduction/)
