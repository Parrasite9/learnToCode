...
![studio ghibli landscape](https://i.imgur.com/TYpBPdc.jpg)

You'll be creating a simple, terminal-based Python game that utilizes `print` and `input` to send messages and receive input from the user.

#### Learning Objectives

- Putting everything you've learned so far together (lists, libraries, loops, conditionals)
...
1. Inside today's homework folder, make a `landscaper` directory. CD into the directory and touch a `game.py` file. This is where you will be writing your code for this game.

1. Now that you're all set up, using Python, simulate the following simple game:  
...
Inside the `landscaper` folder you should have an `game.py` that simulates the landscaper game outlined above.

Your app must have:

- The ability to take user input
- The ability for the user to earn money
- The ability to buy at least one tool (scissors) and use the new tool

If you finish all of the above early with time to spare, try to complete as much more of the game as you can!  

Bonus, but not required for completion:  

- The ability to buy all the other tools after scissors
