...
* [Move your routes to a controller file](optional_router.md)
* [Add additional relationships](multiple_models/) (models can be related in a one-to-many relationship, for example).
* [Include **sign up/log in** functionality, with encrypted passwords & an authorization flow.](Session_and_Auth/)
* Use EJS Partials.
...
**This deployment is more complex than the github pages deployment, so please use the following notes and immediately get a basic app installed:**

- [Deploying to Heroku and Setting up MongoDB Atlas](./deployment.md)
...
Your project is due on Wednesday Nov 30 at 9AM EST. You will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your project to [this google sheet](https://docs.google.com/spreadsheets/d/1PBebVv7AfDxj56hM8AMjM7IFWPk8I5_RfyZhsGp-7pI/edit?usp=sharing).
...
1. After all other avenues have been exhausted, seek help from your assigned instructor. Please refer to [How to Ask a Question](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Ewoks/wiki/How-To-Ask-A-Question) before you reach out.
